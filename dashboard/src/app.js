            ...
            tableRowsHtml += `
                <tr class="campaign-grid-row" data-id="${c.id}">
                    ...
                    <td style="text-align: center; padding: 4px !important;">
                        <button class="btn btn-row-delete" style="padding: 4px 8px; font-size: 11px; white-space: nowrap; display: inline-flex; align-items: center; justify-content: center; gap: 4px; height: 26px; width: auto; min-width: 62px;" onclick="deleteCampaignGridRow('${c.id}')">🗑️ 削除</button>
                    </td>
                </tr>
            `;
        });
